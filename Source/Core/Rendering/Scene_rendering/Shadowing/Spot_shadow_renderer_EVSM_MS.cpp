...
Handle<Shader_resource_view>& Spot_shadow_renderer_EVSM_MS::shadow_map()
{
	return shadow_map_->shader_resource_view();
}

uint32_t Spot_shadow_renderer_EVSM_MS::filter_kernel_size() const
{
	return filter_kernel_size_;
}

const float4* Spot_shadow_renderer_EVSM_MS::filter_kernel() const
{
